  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      general = {
        ...
        "col.inactive_border" = "rgba(${hexToRgba config.colorScheme.palette.base05},0.8)";
	...
	shadow = {
	  range = 6;
	  render_power = 1;
	  color = "rgba(${hexToRgba config.colorScheme.palette.base07},0.3)";
	  color_inactive = "rgba(${hexToRgba config.colorScheme.palette.base05},0.2)";
	};
        blur = {
          size = 4;
          passes = 3;

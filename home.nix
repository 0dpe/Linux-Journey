...

{
  ...
  programs.waybar = {
    ...
    settings.bar = {
      ...
      wireplumber = {
        format = "{volume}%<span size='135%' line_height='0.1' rise='-1500' letter_spacing='1'> 󰕾</span>";
        format-muted = "{volume}%<span size='135%' line_height='0.1' rise='-1.2pt' letter_spacing='1'> 󰸈</span>";
